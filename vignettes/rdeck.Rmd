...
The mapbox base maps require a mapbox account and access token. To avoid sharing an access token,
these examples replace the usual mapbox base maps with a crude geojson countries outline.
