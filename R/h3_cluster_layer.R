#' [H3ClusterLayer](https://github.com/uber/deck.gl/blob/v8.0.16/docs/layers/h3-cluster-layer.md) deck.gl layer.
#'
...
#'
#' @param get_hexagons accessor | [`htmlwidgets::JS`]
#'
...
#'
#' @returns `H3ClusterLayer` & [`layer`]
#'  A [H3ClusterLayer](https://github.com/uber/deck.gl/blob/v8.0.16/docs/layers/h3-cluster-layer.md) layer.
...
#'
#' @export
h3_cluster_layer <- function(id = NULL,
                             data = NULL,
                             visible = TRUE,
                             pickable = FALSE,
                             opacity = 1,
                             ...
                             material = TRUE,
                             ...) {
  get_hexagons <- substitute(get_hexagons) %>%
...
#' Add a [H3ClusterLayer](https://github.com/uber/deck.gl/blob/v8.0.16/docs/layers/h3-cluster-layer.md) deck.gl layer to an [rdeck] map.
#'
...
#'  An [rdeck] map.
#'
#' @inheritParams h3_cluster_layer
#' @inheritDotParams h3_cluster_layer
#'
#' @returns [`rdeck`]
#'  The [rdeck] map.
#'
...
add_h3_cluster_layer <- function(rdeck,
  ...
  layer <- do.call(h3_cluster_layer, params)
