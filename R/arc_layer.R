#' [ArcLayer](https://github.com/uber/deck.gl/blob/v8.0.16/docs/layers/arc-layer.md) deck.gl layer.
#'
#' @name arc_layer
#'
#' @param id [`character`]
...
#'
#' @returns `ArcLayer` & [`layer`]
#'  A [ArcLayer](https://github.com/uber/deck.gl/blob/v8.0.16/docs/layers/arc-layer.md) layer.
