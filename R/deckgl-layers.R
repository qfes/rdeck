...
add_cpu_grid_layer <- function(rdeck,
  ...
  validate_grid_aggregator(cpu_grid_layer)
...
add_grid_layer <- function(rdeck,
  ...
  validate_grid_aggregator(grid_layer)
...
add_tile3d_layer <- function(rdeck,
  ...
  # validate layer props
  validate_data(tile3d_layer)
  validate_visible(tile3d_layer)
  validate_pickable(tile3d_layer)
  validate_opacity(tile3d_layer)
  validate_position_format(tile3d_layer)
  validate_color_format(tile3d_layer)
  validate_auto_highlight(tile3d_layer)
  validate_highlight_color(tile3d_layer)
  validate_get_point_color(tile3d_layer)
  validate_point_size(tile3d_layer)
  validate_load_options(tile3d_layer)
  validate_loader(tile3d_layer)
  # add layer to map
