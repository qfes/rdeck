#' [PolygonLayer](https://github.com/uber/deck.gl/blob/v8.0.16/docs/layers/polygon-layer.md) deck.gl layer.
#'
#' @name polygon_layer
#'
#' @param id [`character`]
...
#'
#' @returns `PolygonLayer` & [`layer`]
#'  A [PolygonLayer](https://github.com/uber/deck.gl/blob/v8.0.16/docs/layers/polygon-layer.md) layer.
...
#'
#' @export
polygon_layer <- function(id = NULL,
                          data = NULL,
                          visible = TRUE,
                          pickable = FALSE,
                          opacity = 1,
