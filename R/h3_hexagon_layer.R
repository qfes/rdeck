...
#' Add a [H3HexagonLayer](https://github.com/uber/deck.gl/blob/v8.0.16/docs/layers/h3-hexagon-layer.md) deck.gl layer to an [rdeck] map.
#'
...
#'  An [rdeck] map.
#'
#' @inheritParams h3_hexagon_layer
#' @inheritDotParams h3_hexagon_layer
#'
#' @returns [`rdeck`]
#'  The [rdeck] map.
#'
...
add_h3_hexagon_layer <- function(rdeck,
  ...
  layer <- do.call(h3_hexagon_layer, params)
